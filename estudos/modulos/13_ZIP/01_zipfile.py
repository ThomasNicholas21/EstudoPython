...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula_zip_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aulazip_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aulazip_descompactado'
...
# extraindo arquivo
with ZipFile(CAMINHO_DESCOMPACTADO, 'w') as zip_:
