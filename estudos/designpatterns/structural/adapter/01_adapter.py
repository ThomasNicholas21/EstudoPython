"""
Abordagem utilizando composição
"""
...
class ControlAdapter:
    def __init__(self, new_controler):
        self.new_controler = new_controler

    def top(self) -> None:
        self.new_controler.move_top()

    def down(self) -> None:
        self.new_controler.move_down()

    def left(self) -> None:
        self.new_controler.move_left()

    def right(self) -> None:
        self.new_controler.move_right()
...
if __name__ == "__main__":
    ...
    control_adapter = ControlAdapter(new_control)
    control_adapter.top()
