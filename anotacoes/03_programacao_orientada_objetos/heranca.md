## Herança
- **O que é?**
    - Na programação orientada a objeto, herança é a capacidade de uma classe filha herdar as características e comportamento da classe pai. Ou seja, o objeto é o outro objeto.
- **Vantangens:**
